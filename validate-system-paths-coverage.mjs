...
// `git ls-files` also returns paths deleted in the working tree until their
// deletion is staged. Validate the release tree that actually exists.
const orphans = tracked.filter((f) => existsSync(join(ROOT, f)) && !covered(f));
