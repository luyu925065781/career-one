...
.co-aiorb__glow{position:absolute;inset:0;border-radius:50%;background:color-mix(in srgb,var(--color-brand) 28%,transparent);filter:blur(18px);animation:co-aiorb-pulse 2.4s ease-in-out infinite}
.co-aiorb__ring{position:absolute;inset:0;border-radius:50%;border:2px solid color-mix(in srgb,var(--color-brand) 25%,transparent);border-top-color:var(--color-brand);animation:co-aiorb-spin 1.1s linear infinite}
.co-ailedger{display:inline-flex;flex-wrap:wrap;align-items:center;justify-content:center;gap:.45rem;border-radius:999px;border:1px solid color-mix(in srgb,var(--color-brand) 30%,transparent);background:var(--color-brand-soft);color:var(--brand-text);padding:.4rem .9rem;font-size:12.5px;font-weight:600}
html.dark .co-ailedger{color:var(--brand-text)}
    ...
    <>
      ...
      <div className="co-aihunt">
        ...
        <span className="co-aiorb">
          ...
          <Sparkles className="size-6 text-icon-brand" />
        </span>
