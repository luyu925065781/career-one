...
const STYLE = `
.co-reason__dot{width:.5rem;height:.5rem;border-radius:50%;background:var(--color-brand);box-shadow:0 0 0 0 color-mix(in srgb,var(--color-brand) 50%,transparent);animation:co-reason-pulse 1.5s ease-out infinite}
  ...
  return (
    <div className="w-full max-w-2xl rounded-2xl border border-border/70 bg-surface/80 text-left shadow-xl shadow-black/10 backdrop-blur-md">
      ...
      <div className="flex items-center gap-2 border-b border-border/60 px-4 py-2.5">
        ...
        <span className="text-[12px] font-medium text-foreground">实时分析</span>
        <Sparkles className="ml-auto size-3.5 text-icon-brand" />
      </div>
