...
// Cost honesty rendered at the POINT OF CHOICE: deterministic algorithm scan (default)
  ...
  return (
    <div className="flex w-full rounded-xl border border-border bg-surface/40 p-1 sm:inline-flex sm:w-auto">
      ...
      >
        ...
        <span className="font-medium">算法扫描</span>
      ...
      >
        ...
        {!cliConfigured && <span className="text-[10px] text-faint">需要 CLI</span>}
      </button>
    </div>
  );
}
