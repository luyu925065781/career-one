...
.co-bd__halo.a{left:-6%;top:-14%;background:radial-gradient(circle at center,color-mix(in srgb,var(--color-brand) 48%,transparent),color-mix(in srgb,var(--color-brand) 12%,transparent) 45%,transparent 70%);animation:co-halo-a 15s ease-in-out infinite}
...
html:not(.dark) .co-bd__halo.a{background:radial-gradient(circle at center,color-mix(in srgb,var(--color-brand) 50%,transparent),color-mix(in srgb,var(--color-brand) 12%,transparent) 45%,transparent 70%)}
