  ...
  return (
    <>
      ...
      <header className="co-mnav flex items-center gap-2 border-b border-border px-4 pb-3 md:hidden">
        <Link href="/" className="flex min-h-[44px] items-center gap-2" aria-label="择程AI首页">
          <CoMark size={26} />
          <span className="font-sans text-lg font-semibold tracking-normal text-landing">择程AI</span>
        </Link>
