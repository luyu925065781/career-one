    ...
    <div className="mx-auto max-w-4xl px-6 py-10">
      ...
      <div className="mt-6 grid grid-cols-2 gap-4 sm:grid-cols-4">
        ...
        <Stat
          value={interviews}
          label="面试"
          hint={interviews === 0 ? "持续做好跟进，推动回复转化为面试 →" : undefined}
        />
        <Stat
          value={offers}
          label="Offer"
          hint={offers === 0 ? "保持面试沟通，持续推动流程 →" : undefined}
        />
      </div>

      <Section title="求职漏斗阶段">
        {stageCounts.map((s) => (
          <Bar
            key={s.key}
            label={s.label}
      ...
      <Section title="重点公司" id="companies">
