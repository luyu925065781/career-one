...
import { rootScript } from "@/lib/career-one";
import { parseExplorePatch, DEFAULT_FILTERS, type DiscoveredOffer, type ScanEvent } from "@/lib/explore";

// Discovery is HTTP-bound across public target-company career pages. It is FREE:
// zero LLM tokens, and --dry-run writes nothing until the user explicitly adds a job.
