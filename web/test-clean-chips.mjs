...
test("formats target roles for pasting into recruitment platforms", () => {
  assert.equal(formatJobSearchKeywords(["AI 产品经理", "Agent 产品", "Chief of Staff"]), "AI 产品经理，Agent 产品，Chief of Staff");
});

test("drops blank and duplicate target roles before copying", () => {
  assert.equal(formatJobSearchKeywords(["AI 产品经理", " ", "ai 产品经理", "Agent 产品"]), "AI 产品经理，Agent 产品");
});
