...
> 面向中国大陆用户的本地优先 AI 求职工作台。

择程AI让你正在使用的 Codex、Claude Code、OpenCode、TRAE 、Workbuddy等 Agent 成为个人求职助手：智能优化你提供的初始简历，生成求职画像、面试故事库，完成岗位评估、简历定制、面试准备和投递管理。项目、Skill 与命令的技术标识为 `career-one`。
