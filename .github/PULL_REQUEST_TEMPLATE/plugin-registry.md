<!--
Use this template for a PR that adds or updates ONE system/plugins-registry/<id>.json file.
...
```json
{
  "name": "career-one-plugin-<name>",
  "id": "<name>",
  "repo": "https://github.com/<you>/career-one-plugin-<name>",
  "author": "<you>",
  "hooks": ["provider"],
...
- [ ] Naming `career-one-plugin-<name>`; `id` == name minus the prefix
