...
const CODEX_SOURCE = join(ROOT, "system", "packages", "codex-plugin", "career-one");
...
function copyRuntimePath(relativePath, runtimeRoot) {
  const sourceRelativePath = runtimeSourcePath(relativePath);
  const source = join(ROOT, ...sourceRelativePath.replace(/\/$/, "").split("/"));
