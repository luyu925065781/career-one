// @ts-check
/**
 * seeds/vc-portfolios.mjs — VC portfolio seed fetchers for career-one.
 *
 ...
 *   node career-one.mjs scan-full --seeds yc
 *   node career-one.mjs scan-full --seeds yc,a16z --since 7 --dry-run
 *
 * Direct usage:
...
const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; career-one-seeds/1.0)';
