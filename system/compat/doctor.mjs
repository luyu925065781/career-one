...
/**
 * doctor.mjs — Setup validation for career-one
...
function checkPlaywrightMcp(root) {
  ...
  return {
    ...
    fix: [
      ...
      'Tracking: https://github.com/luyu925065781/career-one/issues/506',
    ],
  };
}
...
const USER_LAYER_PREREQS = [
  ...
  },
  {
    ...
    fix: [
      'Run: cp system/config/profile.example.yml config/profile.yml',
...
function checkFonts() {
  const systemFontsDir = join(projectRoot, 'system', 'fonts');
