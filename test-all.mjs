...

{
  ...
  try {
    ...
    writeFileSync(join(claudeDir, 'SKILL.md'), pointer);
    writeFileSync(join(opencodeDir, 'SKILL.md'), pointer);
    gitRun(['add', '--', '.agents/skills/career-one/SKILL.md']);
    ...
    const claudeBlob = gitRaw(['show', ':.claude/skills/career-one/SKILL.md']);
    const opencodeBlob = gitRaw(['show', ':.opencode/skills/career-one/SKILL.md']);
