...
import { parseActiveInterviews, extractFriction, aggregateProcessQuality } from '../../scripts/analysis/process-quality.mjs';
...
const scriptPath = join(dirname(dirname(dirname(fileURLToPath(import.meta.url)))), 'scripts/analysis/process-quality.mjs');
