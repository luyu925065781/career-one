...
import { detectReposts, parseScanHistory } from '../../scripts/analysis/detect-reposts.mjs';
import { roleFuzzyMatch } from '../../scripts/scan/role-matcher.mjs';
...
const scriptPath = join(dirname(dirname(dirname(fileURLToPath(import.meta.url)))), 'scripts/analysis/detect-reposts.mjs');
