# Career-One on the Free Tier (Antigravity CLI)

career-one works with **Antigravity CLI's free tier** — no API key or paid
...
a rate-limit error; career-one will pause and suggest retrying tomorrow.
