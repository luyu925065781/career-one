# career-one-plugin-{{NAME}}

A community plugin for [career-one](https://github.com/luyu925065781/career-one).
...
```bash
# Once it's in the career-one registry:
...
Open a registry PR against career-one (see
[docs/PLUGINS.md](https://github.com/luyu925065781/career-one/blob/main/docs/PLUGINS.md)).
