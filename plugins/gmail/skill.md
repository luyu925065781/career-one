---
name: career-one-plugin-gmail
description: How to pull job leads from a Gmail label into the career-one pipeline.
license: MIT
---
...
- `node career-one.mjs plugins run gmail` — ingest new leads from the configured label.
