 ...
 * Loaded from config/tracker-aliases.json — the ONE shared alias table, which the web
...
export const HEADER_ALIASES = (() => {
  ...
  try {
    ...
    throw new Error(
      `tracker-parse.mjs: cannot load config/tracker-aliases.json (${e.message}). ` +
      'The file ships with career-one under config/ — restore it ' +
