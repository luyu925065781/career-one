 ...
 *
 * Usage:
 *   node career-one.mjs archive <url>
 *   node career-one.mjs archive <url> --company=Anthropic --role=senior-ai-engineer
 *   node career-one.mjs archive --pipeline          Archive pending URLs in data/pipeline.md
 *   node career-one.mjs archive --dry-run <url>     Preview filename without saving
 *
...
if (args.length === 0 || args[0] === '--help' || args[0] === '-h') {
  console.log(`
╔══════════════════════════════════════════════════════════════════╗
║           career-one — Job Posting Archiver                     ║
╚══════════════════════════════════════════════════════════════════╝
  ...
  USAGE
    node career-one.mjs archive <url>
    node career-one.mjs archive <url> --company=Anthropic --role=senior-ai-engineer
    node career-one.mjs archive --pipeline     Archive all pending URLs in data/pipeline.md
    node career-one.mjs archive --dry-run <url>
  ...
  EXAMPLES
    node career-one.mjs archive "https://jobs.ashbyhq.com/anthropic/abc123"
    node career-one.mjs archive "https://boards.greenhouse.io/openai/jobs/456" --company=OpenAI
    node career-one.mjs archive --pipeline
