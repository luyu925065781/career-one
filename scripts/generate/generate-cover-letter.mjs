 ...
 *
 * Usage:
 *   node career-one.mjs cover-letter --payload payload.json
 *   node career-one.mjs cover-letter --payload payload.json --out output/slug-cover.pdf
 *
...
async function main() {
  ...
  if (args.help || !args.payload) {
    console.log(`
Usage:
  node career-one.mjs cover-letter --payload payload.json [--out output/path.pdf]
