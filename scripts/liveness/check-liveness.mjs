 ...
 *
 * Usage:
 *   node career-one.mjs liveness <url1> [url2] ...
 *   node career-one.mjs liveness --file urls.txt
 *
...
async function main() {
  ...
  if (positional.length === 0) {
    console.error('Usage: node career-one.mjs liveness [--no-fallback] [--throttle[=ms]] <url1> [url2] ...');
    console.error('       node career-one.mjs liveness [--no-fallback] [--throttle[=ms]] --file urls.txt');
    process.exit(1);
  }
