 ...
 *
 * Run: node career-one.mjs stats             (JSON to stdout)
 *      node career-one.mjs stats --summary   (human-readable table)
 *
 ...
 *
 * This is the canonical funnel definition for career-one going forward;
