# 공통 컨텍스트 -- career-one (한국어)

<!-- ============================================================
     사용 전 개인 설정 안내
     ============================================================
     이 파일은 한국어 career-one 모드 전체에서 공유하는 컨텍스트입니다.
     career-one를 사용하기 전에 반드시 다음을 준비하세요.
...
1b. **세션 첫 평가:** Bash로 `node career-one.mjs sync-check`를 실행합니다. 경고가 있으면 후보자에게 알립니다.
