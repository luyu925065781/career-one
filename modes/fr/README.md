# career-one -- Modes francophones (`modes/fr/`)

Ce dossier contient les traductions francaises des principaux modes career-one pour les candidats qui ciblent le marche francophone (France, Belgique, Suisse romande, Luxembourg, Quebec).
