# Contexte partage -- career-one (Francais)

<!-- ============================================================
     PERSONNALISATION DE CE FICHIER
     ============================================================
     Ce fichier contient le contexte partage pour tous les modes
     career-one en version francaise. Avant d'utiliser career-one, tu DOIS :
...
1b. **Premiere evaluation de chaque session :** Lancer `node career-one.mjs sync-check` via Bash. En cas d'alertes, prevenir le candidat
