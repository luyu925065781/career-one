# career-one -- Tryby polskie (`modes/pl/`)

Ten folder zawiera polskie tłumaczenia głównych trybów career-one dla kandydatów celujących w polski rynek pracy (Polska oraz polskojęzyczne zespoły).
