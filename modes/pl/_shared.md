# Wspólny kontekst -- career-one (Polski)

<!-- ============================================================
     PERSONALIZACJA TEGO PLIKU
     ============================================================
     Ten plik zawiera wspólny kontekst dla wszystkich trybów
     career-one w wersji polskiej. Zanim użyjesz career-one, MUSISZ:
...
1b. **Pierwsza ocena każdej sesji:** Uruchom `node career-one.mjs sync-check` przez Bash. W razie ostrzeżeń poinformuj kandydata
