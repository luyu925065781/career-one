...
5. **career-one proof point**: dołącz w "Informacje dodatkowe", jeśli takie pole istnieje
...
1. Zaktualizuj status na "Applied" kanonicznym CLI: `node career-one.mjs set-status <report#> Applied` (nie edytuj tabeli `applications.md` ręcznie)
2. Zaktualizuj Blok G reportu finalnymi odpowiedziami
3. Zasugeruj następny krok: `/career-one contacto` dla LinkedIn outreach do hiring managera
