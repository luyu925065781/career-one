# Общий контекст — career-one (Русский)
...
<!-- ============================================================
     ...
     Перед использованием career-one убедитесь:
...
1b. **Первая оценка в сессии:** Запустить `node career-one.mjs sync-check`. Если предупреждения — уведомить пользователя.
