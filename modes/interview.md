...
When the user runs `/career-one interview`, execute this interactive profile/CV interview flow.
...
4. Run `node career-one.mjs doctor` silently to verify project integrity.
