...
معالجة وفحص روابط الوظائف المخزنة في صندوق الوارد بملف `data/pipeline.md`. يقوم المستخدم بإضافة روابط الفرص التي تسترعي انتباهه في أي وقت، ثم يقوم بتشغيل الأمر `/career-one pipeline` ليقوم النظام بمعالجتها وتقييمها بالكامل تلقائياً.
...
4. **بعد اكتمال جميع التقييمات**: قم بتشغيل `node career-one.mjs merge` لدمج جميع إضافات التتبع في ملف `data/applications.md` وتجنب التكرارات.
