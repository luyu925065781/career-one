# Geteilter Kontext -- career-one (Deutsch)

<!-- ============================================================
     ANPASSEN DIESER DATEI
     ============================================================
     Diese Datei enthält den geteilten Kontext für alle career-one-Modi
     in der deutschen Variante. Bevor du career-one verwendest, MUSST du:
...
1b. **Bei der ersten Bewertung jeder Session:** `node career-one.mjs sync-check` per Bash ausführen. Bei Warnungen den Kandidaten informieren, bevor weitergearbeitet wird
