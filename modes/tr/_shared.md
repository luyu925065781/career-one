# Ortak Bağlam -- career-one (Türkçe)
...
1b. **Her oturumun ilk değerlendirmesinde:** `node career-one.mjs sync-check` çalıştır. Uyarı varsa adayı bilgilendirmeden devam etme
