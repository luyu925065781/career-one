...
1. Durumu kanonik CLI ile `Applied` yap: `node career-one.mjs set-status <report#> Applied` (`applications.md` tablosunu elle düzenleme)
2. Blok G'yi final yanıtlarla güncelle
3. Sonraki adımı öner: İşe alım sorumlusuna LinkedIn erişimi için `/career-one contacto`
