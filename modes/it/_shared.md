# Contesto condiviso -- career-one (Italiano)

<!-- ============================================================
     PERSONALIZZAZIONE DI QUESTO FILE
     ============================================================
     Questo file contiene il contesto condiviso per tutte le modalità
     career-one in versione italiana. Prima di usare career-one, DEVI:
...
1b. **Prima valutazione di ogni sessione:** eseguire `node career-one.mjs sync-check` via Bash. In caso di avvisi, informare il candidato.
