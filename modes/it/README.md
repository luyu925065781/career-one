# career-one -- Modalità in italiano (`modes/it/`)

Questa cartella contiene le traduzioni in italiano delle principali modalità di career-one per i candidati che si rivolgono al mercato italiano.
