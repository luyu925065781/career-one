# career-one -- Mode Bahasa Indonesia (`modes/id/`)

Folder ini berisi terjemahan Bahasa Indonesia dari mode-mode utama career-one untuk kandidat yang membidik pasar kerja Indonesia (startup tech, perusahaan, dan portal seperti Glints, Jobstreet, Kalibrr, LinkedIn ID).
