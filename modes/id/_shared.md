# Konteks bersama -- career-one (Bahasa Indonesia)

<!-- ============================================================
     PERSONALISASI FILE INI
     ============================================================
     File ini berisi konteks bersama untuk semua mode career-one
     versi Bahasa Indonesia. Sebelum memakai career-one, kamu HARUS:
...
1b. **Evaluasi pertama setiap sesi:** Jalankan `node career-one.mjs sync-check` via Bash. Jika ada peringatan, beri tahu kandidat
