# Contexto compartido -- career-one (Español)

<!-- ============================================================
     PERSONALIZACIÓN DE ESTE ARCHIVO
     ============================================================
     Este archivo contiene el contexto compartido para todos los modos
     career-one en versión española. Antes de usar career-one, DEBES:
...
1b. **Primera evaluación de cada sesión:** Ejecutar `node career-one.mjs sync-check` via Bash. Si hay alertas, avisar al candidato
