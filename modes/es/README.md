# career-one -- Modos en español (`modes/es/`)

Esta carpeta contiene las traducciones al español de los principales modos de career-one para candidatos que apuntan al mercado hispanohablante (España, México, Argentina, Colombia, Chile y otros países de LATAM).
