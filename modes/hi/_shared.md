# साझा संदर्भ -- career-one (हिन्दी)

<!-- ============================================================
     इस फ़ाइल को कस्टमाइज़ करें
     ============================================================
     इस फ़ाइल में career-one के सभी हिन्दी मोड्स के लिए
     साझा संदर्भ है। career-one उपयोग करने से पहले आपको:
...
1b. **हर session का पहला evaluation:** `node career-one.mjs sync-check` via Bash run करें। Alerts पर candidate को सूचित करें
