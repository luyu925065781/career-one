# Delt kontekst -- career-one (Dansk)

<!-- ============================================================
     TILPASNING AF DENNE FIL
     ============================================================
     Denne fil indeholder den delte kontekst for alle career-one-modes
     i den danske version. Før du bruger career-one, SKAL du:
...
1b. **Første evaluering i hver session:** Kør `node career-one.mjs sync-check` via Bash. Ved advarsler, informér kandidaten
