# career-one -- Danske modes (`modes/da/`)

Denne mappe indeholder de danske oversættelser af de vigtigste career-one-modes for kandidater, der søger på det danske marked.
