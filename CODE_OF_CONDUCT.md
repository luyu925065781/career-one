...
We as members, contributors, and maintainers pledge to make participation in career-one a harassment-free experience for everyone, regardless of age, body size, disability, ethnicity, sex characteristics, gender identity and expression, level of experience, education, socio-economic status, nationality, personal appearance, race, religion, or sexual identity and orientation.
...
需要私密报告不当行为时，请使用仓库的 [Private vulnerability reporting](https://github.com/luyu925065781/career-one/security/advisories/new)，并在标题中注明 `Code of Conduct`。所有投诉都会被审查。
...
This Code of Conduct applies within the project's GitHub spaces and when an individual is representing the project in public spaces.
