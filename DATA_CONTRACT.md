...
| `distribution/*` | Cross-platform package builder, runtime allowlist, and distribution tests |
| `packages/codex-plugin/*` | Codex plugin source manifest; generated packages live under ignored `dist/` |
