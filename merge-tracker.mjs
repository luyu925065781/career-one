 ...
 *
 * Run: node career-one/merge-tracker.mjs [--dry-run] [--verify]
 */
...
const CAREER_ONE = dirname(fileURLToPath(import.meta.url));
...
if (VERIFY && !DRY_RUN) {
  ...
  try {
    execFileSync('node', [join(CAREER_ONE, 'verify-pipeline.mjs')], { stdio: 'inherit' });
  } catch (e) {
    process.exit(1);
  }
}
